export const styles = {
  ...
  aside:
    'z-20 flex flex-col justify-between w-1/5 p-6 bg-white drop-shadow-lg shadow-slate-800 fixed top-0 bottom-0 h-screen overflow-y-auto left-0 transition-all transform duration-300',
  submenu:
  ...
  fontTitle: 'font-bold text-indigo-500 text-2xl',
};
